              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    ...
                    color: widget.coffee.detail[widget.index].isFav
                        ? Colors.red
                        : Colors.black,
                    onPressed: () {
                      setState(() {
                        widget.coffee.detail[widget.index].isFav =
                            !widget.coffee.detail[widget.index].isFav;
                      });
                      Provider.of<CoffeeNewProvider>(context, listen: false)
                          .addFavorite(SelectedCoffeeDetail(
                              coffeeTypeName: widget.coffee.name,
                              detail: CoffeeDetail(
                                  nameDetail: widget
                                      .coffee.detail[widget.index].nameDetail,
                                  image:
                                      widget.coffee.detail[widget.index].image,
                                  desc: widget.coffee.detail[widget.index].desc,
                                  price:
                                      widget.coffee.detail[widget.index].price,
                                  isFav: widget
                                      .coffee.detail[widget.index].isFav)));
                    },
                  )
                ],
              ),
